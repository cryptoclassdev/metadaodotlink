    ...
    <div className="flex flex-col items-center text-center">
      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow: `
              ...
              0 12px 32px rgba(235, 90, 84, 0.15)
            `,
          }}
        >
          <Image src={imageUrl || "/placeholder.svg"} alt={name} fill className="object-contain p-3" priority />
        </div>
        ...
        <div
          ...
          style={{
            boxShadow: "0 0 40px 8px rgba(235, 90, 84, 0.1)",
          }}
        />
      </motion.div>
