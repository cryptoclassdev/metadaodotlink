    ...
    >
      ...
      >
        ...
        <div className="bg-white flex-1 p-4 flex flex-col">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="flex items-center gap-1">
                  <span className="font-bold text-sm">Futards</span>
                  <span className="text-yellow-500">✓</span>
                </div>
                <div className="text-gray-500 text-xs">
                  @Futards · <span className="text-blue-500">Follow</span>
                </div>
              </div>
            </div>
          ...
          {/* Tweet Text */}
          <p className="text-sm text-gray-900 mb-3">Check out Futards - The future of prediction markets:</p>
